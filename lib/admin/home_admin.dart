          ...
          children: [
            ...
            GestureDetector(
              ...
              child: Container(
                ...
                child: Row(children: [
                  Padding(padding: EdgeInsets.all(6.0),
                    child: Image.asset("images/inventory.png", height: 80, width: 80, fit: BoxFit.cover,),),
                  SizedBox(width: 30.0,) ,
                  Text("Inventory", style: TextStyle(color: Colors.white, fontSize: 20.0, fontWeight: FontWeight.bold),) ],),
              ),
            )
          ],
        ),
